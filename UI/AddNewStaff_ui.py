...
################################################################################
## Form generated from reading UI file 'AddNewStaff.ui'
##
...
class Ui_AddNewStaffDialog(object):
    ...
    def retranslateUi(self, AddNewStaffDialog):
        ...
        self.qlabelAddStaff.setText(QCoreApplication.translate("AddNewStaffDialog", u"Add New Staff", None))
        self.leEnterStaffName.setPlaceholderText(QCoreApplication.translate("AddNewStaffDialog", u"Enter First Name", None))
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("AddNewStaffDialog", u"Enter Last Name", None))
        self.lineEdit_4.setPlaceholderText(QCoreApplication.translate("AddNewStaffDialog", u"Age", None))
        self.lineEdit_2.setPlaceholderText(QCoreApplication.translate("AddNewStaffDialog", u"Phone number", None))
        self.lineEdit_3.setPlaceholderText(QCoreApplication.translate("AddNewStaffDialog", u"Email", None))
        self.lineEdit_5.setPlaceholderText(QCoreApplication.translate("AddNewStaffDialog", u"Designation", None))
        self.radioButton.setText(QCoreApplication.translate("AddNewStaffDialog", u"Male", None))
        self.radioButton_2.setText(QCoreApplication.translate("AddNewStaffDialog", u"Female", None))
