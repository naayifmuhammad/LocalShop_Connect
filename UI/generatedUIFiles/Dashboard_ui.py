...
"}")
        ...
        QWidget.setTabOrder(self.cartView, self.confirmBillBtn)
        QWidget.setTabOrder(self.confirmBillBtn, self.cancelBillBtn)
        QWidget.setTabOrder(self.cancelBillBtn, self.hamburger)
        QWidget.setTabOrder(self.hamburger, self.billing)
        QWidget.setTabOrder(self.billing, self.products)
        QWidget.setTabOrder(self.products, self.staff)
        QWidget.setTabOrder(self.staff, self.analytics)
        QWidget.setTabOrder(self.analytics, self.history)
        QWidget.setTabOrder(self.history, self.settings)
        QWidget.setTabOrder(self.settings, self.itemNo)
        QWidget.setTabOrder(self.itemNo, self.HSNCode)
        QWidget.setTabOrder(self.HSNCode, self.SalePrice)
        QWidget.setTabOrder(self.SalePrice, self.Amount)
